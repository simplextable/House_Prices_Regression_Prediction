...
#
#scaler = MinMaxScaler()
#veriler_tum[["YearBuilt"]] = scaler.fit_transform(veriler_tum[["YearBuilt"]])
#veriler_tum[["YearRemodAdd"]] = scaler.fit_transform(veriler_tum[["YearRemodAdd"]])
#veriler_tum[["GarageYrBlt"]] = scaler.fit_transform(veriler_tum[["GarageYrBlt"]])
#veriler_tum[["YrSold"]] = scaler.fit_transform(veriler_tum[["YrSold"]])
